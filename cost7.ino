...
void setup() { 
 ...
 // imp tip : i do not know how to get pins for servo so this is fake pins and need edit before burn ...
  ...
  servo[0].write(0);delay(30);
  servo[1].write(0);delay(30);
  servo[2].write(0);delay(30);
  servo[3].write(0);delay(30);
...
millistime = millis()/1000 ; 
 ...
 Serial.println(start[x]);
    ...
    timecar[x] = millistime -  start[x] ; //time by min and min equal  5 s to be more faster 
